...
function Packet() {
	...
	/**
	 * Properties of the current packet
	 */
	var _properties = {
	...
	/**
	 * @returns {Integer} Next packet ID
	 */
	 ...
	 * 
	 * @param {String} crc Optional start sequence to concatenate packet CRC
	 * 
